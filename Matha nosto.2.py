...
lolgo = (f"""\33[1;92m
 ...
 |_____/       |_| \_|      |_|  |_|      |____/ \____/  |_| |_____/  
   ...
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM FAYSAL  \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
def banner():
 ...
 |_____/       |_| \_|      |_|  |_|      |____/ \____/  |_| |_____/  
     ...
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H}ASHRAF MAHDI            {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H} DARK NET HACKER BOYS           {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}DNH boys 1{N}       {H}  ║
      {M}║{M}[{H}•{M}] STATUS    : {H}PAID{P}     {N}  {H}      ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}  ja khusi tai X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H} FAYSAL ')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mD-N-H-BOYS {RED}(TCW)")
...
def _xxx_():
    ...
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/dark.net.hacker.boys1?mibextid=308UXlBs9A8XJry9/')
       _pornhub_()
    if sh =='2':
       os.system('xdg-open https://www.facebook.com/faysal.dnh.1?mibextid=308UXlBs9A8XJry9/')
       _xnxx_()
    if sh =='3':
       os.system('xdg-open https://facebook.com/groups/275913961539106//')
       main()
    else:
        os.system('xdg-open https://github.com/Faysalsf')
        main()
...
def _xnxx_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}D-N-H BOYS)
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}5.0)
    print(f'{M}╚══[•] CODER NAME: {H}FAYSAL')
    print(f" ")
...
def _pompom_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}D-N-H CLONER')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}5.2.0')
    print(f'{M}╚══[•] CODER NAME: {H}FAYSAL ')
    print(" ")
...
def _FUCKER_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}FAYSAL ')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}5.3.0)
